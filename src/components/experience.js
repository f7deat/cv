        ...
        return (
            <div className="mt-4">
                <div className="card mb-3 border-0">
                    <div className="row no-gutters">
                        <div className="col-md-2 d-flex align-items-center">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/2/29/FPT_Software_Logo.png" className="object-fit-cover" width="100%" alt="fsoft" />
                        </div>
                ...
                <div className="card mb-3 border-0">
                    <div className="row no-gutters">
                        <div className="col-md-2 d-flex align-items-center">
                            <img src="https://novaonads.com/wp-content/uploads/2015/08/NovaAds-thay-%C4%91%E1%BB%95i-nh%E1%BA%ADn-di%E1%BB%87n-th%C6%B0%C6%A1ng-hi%E1%BB%87u-th%C3%A0nh-NOVAON-ADS-3.png" className="object-fit-cover" width="100%" alt="novaon" />
                        </div>
                        <div className="col-md-10">
                            <div className="card-body">
                                <h5 className="card-title">Novaon</h5>
                                <p className="card-text text-muted">
                                NOVAON ADS works hard in becoming and maintaining the postion of one of the leading companies in Digital Marketing, in order to creat value in return ...
                                </p>
                                <p className="card-text">
                                    <small className="text-muted">Mar 2019 - Now</small>
                                </p>
                            </div>
                        </div>
                    </div>
